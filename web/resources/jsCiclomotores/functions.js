...
// <editor-fold defaultstate="collapsed" desc="PERMITE OU NÃO ESCREVER NA INPUTTEXT Com nº polícia">
function rb1Pretencao()
{
    if (document.forms['formPretencao']['formPretencao:numeroPol'][0].checked === true 
            ) 
    {
        document.getElementById("formPretencao:numPolLocal").readOnly = false;
        document.getElementById("formPretencao:numPolLocal").style.backgroundColor="lightgrey";
    }
    else
    {
        document.getElementById("formPretencao:numPolLocal").readOnly = true;
        document.getElementById("formPretencao:numPolLocal").style.backgroundColor="red";
        var s= document.getElementById("formPretencao:numPolLocal");
        s.value = '';
    }
}
// </editor-fold>

// <editor-fold defaultstate="collapsed" desc="OCULTA O CAMPO Com nº polícia NA PRETNSÃO">
function cBoxPretencao()
{
    if (document.getElementById("formPretencao:numeroPol2").checked)
    {
        $('#hidden3').hide();
    }
    else
...
{
    if(document.getElementById("formPretencao:copiaProc").checked || document.getElementById("formPretencao:copiaNicPcolReq").checked
...
function showSeRepSing()
{
    ...
    if (document.forms['formPretencao']['formPretencao:rdReqTipo'][0].checked === true  &&
            document.forms['formPretencao']['formPretencao:representanteSimNao'][0].checked === true  &&
            document.forms['formPretencao']['formPretencao:representante'][0].checked === true
            || document.forms['formPretencao']['formPretencao:rdReqTipo'][1].checked === true  &&
            document.forms['formPretencao']['formPretencao:representanteSimNao'][0].checked === true  &&
            document.forms['formPretencao']['formPretencao:representante'][1].checked === true) 

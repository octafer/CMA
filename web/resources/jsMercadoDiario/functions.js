...
function readonly2()
{
    ...
    if (document.forms['formPretencao']['formPretencao:autorizaOcuparDesocupar'][1].checked === false 
            && document.forms['formPretencao']['formPretencao:autorizaOcuparDesocupar'][0].checked === false
            ) 
    {
    
    document.getElementById("formPretencao:desocupar").readOnly = true;
    var s2= document.getElementById("formPretencao:desocupar");
    s2.value = '';
    }
...
{
    if (document.forms['formPretencao']['formPretencao:autorizaOcuparDesocupar'][0].checked === true 
            ) 
    {
    document.getElementById("formPretencao:desocupar").readOnly = true;
    document.getElementById("formPretencao:desocupar").style.backgroundColor="lightgrey";
    var s= document.getElementById("formPretencao:desocupar");
    s.value = '';
     
    }
    if (document.forms['formPretencao']['formPretencao:autorizaOcuparDesocupar'][1].checked === true 
            ) 
    {
        document.getElementById("formPretencao:desocupar").readOnly = false;
    document.getElementById("formPretencao:desocupar").style.backgroundColor="white";

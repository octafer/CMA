...
{
    if(document.getElementById("formPretencao:planta1_25000").checked || document.getElementById("formPretencao:planta1_20000").checked
        || document.getElementById("formPretencao:certidaoPred").checked || document.getElementById("formPretencao:copiaCadernPred").checked
        || document.getElementById("formPretencao:copiaContrArend").checked
